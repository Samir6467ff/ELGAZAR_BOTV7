...
for (let anju of Ayushaudio){
    ...
    if (smallinput=='حفل') {
        reply (`مش هتيجي تاخد امك م ع زوبري ولا اي`)
    }
    
     if (smallinput=='حفل') {
        reply (`ياض يا ابن العرص`)
    }
    
     if (smallinput=='حفل') {
        reply (`ههههههههههههههههههههههههههههههههههههههههههه`)
    }
    
     if (smallinput=='حفل') {
        reply (`عارف انك ديوث ومش هتعرف ترد`)
    }
     ...
     if (smallinput=='حفل') {
        reply (`ياض دي هيجانة خالص مش راضية تسيبو`)
    }
    ...
    if (smallinput=='حفل') {
        reply (`عارف انا ممكن افضل معاها ل تاني يوم عادي بس كسها فحمة`)
    }
    ...
    if (smallinput=='حفل') {
      ...
      if (smallinput=='حفل') {
        reply (`تع يزبي يميت يهربان`)
    }
      
      if (smallinput=='حفل') {
        reply (`يبن كوم شكاير القش يعرصصص`)
    }
